...
def create_impress_document(save_path, image_path):
    try:
        ...
        text_range.setPropertyValue("ParaAdjust", uno.getConstantByName("com.sun.star.style.ParagraphAdjust.CENTER"))
        cursor.setPropertyValue("ParaVertAlign", uno.getConstantByName("com.sun.star.style.ParagraphVertAlign.CENTER"))
